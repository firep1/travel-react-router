    ...
    <div className="bg-darkBackground text-white">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">Trip</h1>
          <p className=" text-sm">
            With Trip you can experience new travel and the best tourist
      ...
      <div>
        <p>
          <p className=" text-center py-4">
            ...
            <span className=" text-brightColor"> xyz</span> | All
            rights reserved
          </p>
        </p>
      </div>
