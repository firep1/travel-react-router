...
const Destination = () => {
  return (
    <div className='min-h-screen flex flex-col justify-center md:mx-32 mx-5'>
        <h1 className='font-medium text-center text-4xl lg:mt-0 mt-16'>Most popular Destination</h1>
        ...
        <div className='flex flex-col lg:flex-row gap-5 mt-14'>
          ...
          <DestinationCard img={img2} title='Dubai, UAE' para='A city of superlatives, Dubai boasts towering skyscrapers, luxury shopping, and desert adventures' />
